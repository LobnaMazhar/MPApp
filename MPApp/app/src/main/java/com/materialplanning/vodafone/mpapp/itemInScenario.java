 ...
 */
public class itemInScenario {
    int itemInScenarioID;
    ...
    public int getitemInScenarioItemID(){
        return itemInScenarioItemID;
    }

    public int getitemInScenarioScenarioID(){
        return itemInScenarioScenarioID;
    }
